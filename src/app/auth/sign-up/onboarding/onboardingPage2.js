...
export default function OnBoadringPage2({ pageNo, setPageNo }) {
  ...
  let onClickHandler = () => {
    ...
    if (file && !["image/png", "image/jpeg", "image/svg"].includes(file.type)) {
    ...
    <div className="flex flex-col h-full justify-center items-center mt-2">
      ...
      <div className="flex justify-center flex-wrap items-center">
        ...
        >
          ...
          <span className="ml-2 text-base font-semibold">Upload Logo</span>
        </label>
        {toOpen && (
          <input
            id="Newlogo"
        ...
        >
          ...
          <span className="ml-2 text-base font-semibold">Edit Logo</span>
        </button>
      </div>
